...
-- All tables use BIGINT with Snowflake IDs or GENERATED BY DEFAULT AS IDENTITY
-- For production use: run this file on a fresh DB, then skip 001-009
...
-- ============================================================
-- Push subscriptions (from 008_push_subscriptions.sql)
-- ============================================================
