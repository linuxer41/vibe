      ...
      <div class="game-area">
        {#if gamePhase === 'lobby'}
          ...
          {:else}
            <div class="waiting-msg">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--text-3)" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
        ...
        {:else if gamePhase === 'finished'}
          <div class="finish-card">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><polyline points="9 12 11 14 15 10"/></svg>
