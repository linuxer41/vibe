      ...
      <div class="note-editor">
        <div class="note-header">
          <button class="back-link" onclick={clearSelection}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linecap="round"><path d="M15 18l-6-6 6-6"/></svg>
          </button>
...
<style>
  ...
  .search-bar { display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: var(--bg-3); border-radius: 12px; margin-bottom: 16px; }
