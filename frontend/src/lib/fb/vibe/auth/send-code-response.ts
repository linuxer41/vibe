...
export class SendCodeResponse {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SendCodeResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSendCodeResponse(bb:flatbuffers.ByteBuffer, obj?:SendCodeResponse):SendCodeResponse {
  return (obj || new SendCodeResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSendCodeResponse(bb:flatbuffers.ByteBuffer, obj?:SendCodeResponse):SendCodeResponse {
...
static startSendCodeResponse(builder:flatbuffers.Builder) {
...
static endSendCodeResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createSendCodeResponse(builder:flatbuffers.Builder, ok:boolean, codeOffset:flatbuffers.Offset, errorOffset:flatbuffers.Offset):flatbuffers.Offset {
